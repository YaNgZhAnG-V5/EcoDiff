...
@dataclass
class SDIBDiffusionPreparaPhasePipelineOutput(BaseOutput):
    ...
    callback_on_step_end_tensor_inputs: Optional[
...
class SDIBDiffusionPipeline(StableDiffusionPipeline):
    ...
    def inference_preparation_phase(
        ...
        **kwargs,
        ...
        return SDIBDiffusionPreparaPhasePipelineOutput(
            latents=latents,
            prompt_embeds=prompt_embeds,
            negative_prompt_embeds=negative_prompt_embeds,
            timesteps=timesteps,
    ...
    def inference_with_grad_denoising_step(
        ...
        i,  # timestep index
        t,  # time
        preparation_phase_output: SDIBDiffusionPreparaPhasePipelineOutput,
        step_index=None,
    ):
