...
CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES accelerate launch scripts/retraining/train_text_to_image_sdxl.py \
  ...
  --output_dir="./results/retrain_results/sdxl_full/prune_$PRUNING_RATIO"
#   --push_to_hub
